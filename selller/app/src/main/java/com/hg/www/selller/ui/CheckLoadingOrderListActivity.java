...
public class CheckLoadingOrderListActivity extends AppCompatActivity {
    ...
    private String mLoadingTimestamp = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.d(TAG, "onCreate");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_check_loading_order_list);
        ...
        mLoadingTimestamp = intent.getStringExtra(getString(R.string.EXTRA_LOADING_TIMESTAMP));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                for (Order order : mAdapter.orders) {
                    order.status = Order.STATUS_LOADED;
                }
                OrderService.updateServerOrders(context, mAdapter.orders, 4,
                        new HttpAsyncTask.OnSuccessListener(){
                            ...
                            public void onSuccess() {
                                for (Order order : mAdapter.orders) {
                                    OrderApi.getInstance().setOrderStatus(order.id, Order.STATUS_LOADED);
                                }
    ...
    public void onUpdateAdapter() {
        ...
        mAdapter.orders =  OrderApi.getInstance().getLoadingOrders(mExpressmanId, mLoadingTimestamp);
