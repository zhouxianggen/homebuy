...
public class PaidOrderListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle = getString(R.string.ACTIVITY_PAID_ORDER);
    ...
    public void onUpdateAdapter() {
        ...
        mAdapter.orders =  OrderApi.getInstance().getOrders(Order.STATUS_PAID);
