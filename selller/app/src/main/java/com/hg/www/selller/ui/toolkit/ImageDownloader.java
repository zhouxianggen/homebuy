...
public class ImageDownloader {
    ...
    public void download(String url, ImageView imageView, int reqWidth, int reqHeight) {
        ...
        if (bitmap == null) {
            forceDownload(url, imageView, reqWidth, reqHeight);
        } else {
    ...
    private void forceDownload(String url, ImageView imageView, int reqWidth, int reqHeight) {
        ...
        if (cancelPotentialDownload(url, imageView)) {
            BitmapDownloaderTask task = new BitmapDownloaderTask(imageView, reqWidth, reqHeight);
    ...
    Bitmap downloadBitmap(String url, int reqWidth, int reqHeight) {
        ...
        if (url.toString().startsWith("http://") || url.toString().startsWith("https://")) {
            ...
            return BitmapToolkit.decodeSampledBitmapFromFile(url, reqWidth, reqHeight);
        }
    }
    ...
    class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
        ...
        public BitmapDownloaderTask(ImageView imageView, int reqWidth, int reqHeight) {
        ...
        protected Bitmap doInBackground(String... params) {
            url = params[0];
            return downloadBitmap(url, reqWidth, reqHeight);
        }
