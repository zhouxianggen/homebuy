...
import com.hg.scanner.barcode.camera.CameraManager;
import com.hg.scanner.barcode.decoding.CaptureActivityHandler;
import com.hg.scanner.barcode.decoding.DecodeFormatManager;
import com.hg.scanner.barcode.view.ViewfinderView;
import com.hg.scanner.barcode.decoding.InactivityTimer;
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            if (decodeFormats == null) {
                Log.d(TAG, "decodeFormats is null");
            }
