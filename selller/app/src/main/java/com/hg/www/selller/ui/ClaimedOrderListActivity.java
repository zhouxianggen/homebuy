...
public class ClaimedOrderListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_claimed_order_list);
    ...
    public void onUpdateAdapter() {
        ...
        mAdapter.orders =  OrderApi.getInstance().getOrders(Order.STATUS_CLAIMED);
