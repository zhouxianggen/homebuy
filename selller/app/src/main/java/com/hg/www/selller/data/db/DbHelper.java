...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_AGENCY_TABLE =
            "CREATE TABLE " + TableSchema.AgencyEntry.TABLE_NAME + " (" +
                    ...
                    TableSchema.AgencyEntry.COLUMN_NAME_TITLE + TEXT_TYPE + COMMA_SEP +
                    TableSchema.AgencyEntry.COLUMN_NAME_PSWD + TEXT_TYPE + COMMA_SEP +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(SQL_DELETE_AGENCY_TABLE);
