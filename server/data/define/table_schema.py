...
#
# schema for table agency
#
class AgencyEntry(object):
	NAME = "agency"
	...
	COLUMNS = [COLUMN_NAME_ID, COLUMN_NAME_TITLE, COLUMN_NAME_PSWD, COLUMN_NAME_ADDRESS, COLUMN_NAME_MODIFY_TIME]
...
class CategoryEntry(object):
	...
	COLUMNS = [COLUMN_NAME_ID, COLUMN_NAME_SELLER_ID, COLUMN_NAME_TITLE, COLUMN_NAME_PARENT, COLUMN_NAME_IMAGE_1, COLUMN_NAME_IMAGE_2, COLUMN_NAME_IMAGE_3, COLUMN_NAME_IMAGE_4, COLUMN_NAME_ITEM_COUNT, COLUMN_NAME_STATUS, COLUMN_NAME_MODIFY_TIME]
...
class CommodityEntry(object):
	...
	COLUMNS = [COLUMN_NAME_ID, COLUMN_NAME_SELLER_ID, COLUMN_NAME_BARCODE, COLUMN_NAME_TITLE, COLUMN_NAME_DESCRIPTION, COLUMN_NAME_PRICE, COLUMN_NAME_THUMBNAIL, COLUMN_NAME_IMAGE_1, COLUMN_NAME_IMAGE_2, COLUMN_NAME_IMAGE_3, COLUMN_NAME_IMAGE_4, COLUMN_NAME_IMAGE_5, COLUMN_NAME_IMAGE_6, COLUMN_NAME_SUPPORT_RETURN, COLUMN_NAME_IN_DISCOUNT, COLUMN_NAME_IN_STOCK, COLUMN_NAME_CATEGORY_ID, COLUMN_NAME_WEEKLY_SALES, COLUMN_NAME_WEEKLY_RETURNS, COLUMN_NAME_STATUS, COLUMN_NAME_MODIFY_TIME]
...
class OrderEntry(object):
	...
	COLUMNS = [COLUMN_NAME_ID, COLUMN_NAME_AGENCY_ID, COLUMN_NAME_SELLER_ID, COLUMN_NAME_COMMODITY_ID, COLUMN_NAME_EXPRESSMAN_ID, COLUMN_NAME_AMOUNT, COLUMN_NAME_PAYMENT, COLUMN_NAME_STATUS]
