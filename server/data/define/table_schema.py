...
class CategoryEntry(object):
	...
	COLUMNS = [COLUMN_NAME_ID, COLUMN_NAME_SELLER_ID, COLUMN_NAME_TITLE, COLUMN_NAME_PARENT, COLUMN_NAME_IMAGE_1, COLUMN_NAME_IMAGE_2, COLUMN_NAME_IMAGE_3, COLUMN_NAME_IMAGE_4, COLUMN_NAME_STATUS, COLUMN_NAME_MODIFY_TIME]
...
class CommodityEntry(object):
	...
	COLUMNS = [COLUMN_NAME_ID, COLUMN_NAME_SELLER_ID, COLUMN_NAME_BARCODE, COLUMN_NAME_TITLE, COLUMN_NAME_DESCRIPTION, COLUMN_NAME_PRICE, COLUMN_NAME_THUMBNAIL, COLUMN_NAME_IMAGE_1, COLUMN_NAME_IMAGE_2, COLUMN_NAME_IMAGE_3, COLUMN_NAME_IMAGE_4, COLUMN_NAME_IMAGE_5, COLUMN_NAME_IMAGE_6, COLUMN_NAME_SUPPORT_RETURN, COLUMN_NAME_IN_DISCOUNT, COLUMN_NAME_IN_STOCK, COLUMN_NAME_CATEGORY_ID, COLUMN_NAME_STATUS, COLUMN_NAME_MODIFY_TIME]
